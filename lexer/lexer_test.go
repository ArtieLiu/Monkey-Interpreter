...
func TestShouldLexBrackets(t *testing.T) {
	input := `[1,2];`
	tests := []struct {
		expectedType    token.TokenType
		expectedLiteral string
...
func TestShouldLexColon(t *testing.T) {
	input := ` {"foo": "bar"}`
	tests := []struct {
		expectedType    token.TokenType
		expectedLiteral string
...
func TestShouldLexOnePlusOne(t *testing.T) {
	input := `1 + 1;`
	tests := []struct {
		expectedType    token.TokenType
		expectedLiteral string
...
func TestShouldLexConditionalKeywords(t *testing.T) {
	input := `if (5 < 10) {
		   return true;
	   } else {
		   return false;
